                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                <div class="text-lg-left">
                                    ...
                                    <h5 class="box-title">NB:This feature  will create e-value and this can only be reversed by an administrator.</h5>
                                    <hr>
                                ...
                                <form method="POST" action="/wallet_configurations/preauth" aria-label="{{ __('Add Product') }}">
                                    @csrf
                                    <div class="box-body">
